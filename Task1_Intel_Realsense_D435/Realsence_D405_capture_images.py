...
File: Realsence_D405_capture_images.py
Description:
...
# 定义保存图像的目录
save_directory = r'E:\ABB-Project\ABB_wrs\suyixuan\ABB\depth_anything_v2\Image_Dataset\Intel_Realsense_D405'
...
# config.enable_stream(rs.stream.color, 1280, 720, rs.format.bgr8, 90)
