...
'''
D435i的2000万像素RGB摄像头和3D传感器可以 30帧/秒的速度提供分辨率高达1280 × 720，
或者以90帧/秒的速度提供848 × 480的较低分辨率。 该摄像头具有全局快门，可以处理快速移动物体，室内室外皆可操作。 
深度距离在0.1 m~10 m之间，视场角度为85 × 58度。 
...
try:
    while True:
        ...
        if key == 13:
            ...
            save_path = r'E:\ABB-Project\ABB_wrs\suyixuan\ABB\Depth_Anything_V2\Point_cloud_Dataset\Intel_Realsense_D435\colored_point_cloud_2025010602.ply'
